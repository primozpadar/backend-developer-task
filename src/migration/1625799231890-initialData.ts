...
export class initialData1625799231890 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    -- NOTE CONTENT TEXT
    insert into "note_content_text" ("id", "noteId", "body") values (1, 21, 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque. Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.');
    insert into "note_content_text" ("id", "noteId", "body") values (2, 22, 'Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh. Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.');
    insert into "note_content_text" ("id", "noteId", "body") values (3, 23, 'Vivamus tortor.');
    insert into "note_content_text" ("id", "noteId", "body") values (4, 24, 'Donec dapibus. Duis at velit eu est congue elementum. In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo. Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis. Sed ante. Vivamus tortor.');
    insert into "note_content_text" ("id", "noteId", "body") values (5, 25, 'Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet. Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam.');
    insert into "note_content_text" ("id", "noteId", "body") values (6, 26, 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus. Phasellus in felis. Donec semper sapien a libero. Nam dui. Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius. Integer ac leo.');
    insert into "note_content_text" ("id", "noteId", "body") values (7, 27, 'Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus. Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.');
    insert into "note_content_text" ("id", "noteId", "body") values (8, 28, 'Aliquam erat volutpat. In congue. Etiam justo. Etiam pretium iaculis justo.');
    insert into "note_content_text" ("id", "noteId", "body") values (9, 29, 'Suspendisse potenti. Cras in purus eu magna vulputate luctus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem. Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo.');
    insert into "note_content_text" ("id", "noteId", "body") values (10, 30, 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius. Integer ac leo.');
    insert into "note_content_text" ("id", "noteId", "body") values (11, 31, 'In hac habitasse platea dictumst. Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat. Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.');
    insert into "note_content_text" ("id", "noteId", "body") values (12, 32, 'Donec semper sapien a libero. Nam dui. Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius. Integer ac leo.');
    insert into "note_content_text" ("id", "noteId", "body") values (13, 33, 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est.');
    insert into "note_content_text" ("id", "noteId", "body") values (14, 34, 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.');
    insert into "note_content_text" ("id", "noteId", "body") values (15, 35, 'Ut tellus. Nulla ut erat id mauris vulputate elementum.');
    insert into "note_content_text" ("id", "noteId", "body") values (16, 36, 'Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.');
    insert into "note_content_text" ("id", "noteId", "body") values (17, 37, 'Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.');
    insert into "note_content_text" ("id", "noteId", "body") values (18, 38, 'Donec semper sapien a libero. Nam dui. Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius. Integer ac leo.');
    insert into "note_content_text" ("id", "noteId", "body") values (19, 39, 'Sed accumsan felis. Ut at dolor quis odio consequat varius. Integer ac leo.');
    insert into "note_content_text" ("id", "noteId", "body") values (20, 40, 'Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis. Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.');
    `);
  }
